...
<head>
	...
	<!-- core:css -->
	<link rel="stylesheet" href="/asset/vendors/core/core.css" type="text/css">

	<!-- endinject -->
  <!-- plugin css for this page -->
	<!-- end plugin css for this page -->
	<!-- inject:css -->
	<link rel="stylesheet" href="/asset/fonts/feather-font/css/iconfont.css" type="text/css">
	<link rel="stylesheet" href="/asset/vendors/flag-icon-css/css/flag-icon.min.css" type="text/css">
	<!-- endinject -->
  <!-- Layout styles -->
	<link rel="stylesheet" href="/asset/css/demo_1/style.css" type="text/css">
  <!-- End layout styles -->
